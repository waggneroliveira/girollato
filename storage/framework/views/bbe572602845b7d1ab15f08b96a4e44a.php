        ...
        <?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <article class="col-12 col-sm-12 col-md-6">
                <div class="d-flex flex-column align-items-center bg-white mb-4 overflow-hidden position-relative">
                    ...
                    src="<?php echo e($news->path_image_thumbnail ? asset('storage/' . $news->path_image_thumbnail) : 'https://placehold.co/600x400?text=Sem+imagem&font=montserrat'); ?>"
                    ...
                    <div class="col-12 my-3 h-100 px-0 d-flex flex-column justify-content-center position-relative">                        
                        ...
                        <p class="text-color my-3 montserrat-regular font-15">
                                <?php echo substr(strip_tags($news->text), 0, 200); ?>...
                        </p>

                        <div class="d-flex justify-content-between align-items-center w-100">
                            <p class="text-color mb-0 montserrat-regular font-12 col-8"><?php echo e($dataFormatada); ?></p>
                            
                            <div id="socialLinks-filter-<?php echo e($news->id); ?>" class="social-links home opacity-0">
                                <div class="d-flex gap-2">
                                    <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($news->title . ' ' . url()->current())); ?>" target="_blank" class="rounded-circle btn btn-sm bg-whatsapp bg-transparent p-0"><i class="fab fa-whatsapp text-dark"></i></a>    
                                    <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($news->title)); ?>" target="_blank" class="rounded-circle btn btn-sm btn-twiter bg-transparent p-0"><i class="fab fa-x-twitter text-dark"></i></a>
                                    <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="rounded-circle btn btn-facebook btn-sm bg-transparent p-0"><i class="fab fa-facebook-f text-dark"></i></a>
                                </div>
                            </div>  

                            <button id="btnShare-filter-<?php echo e($news->id); ?>" 
                                    data-target="socialLinks-filter-<?php echo e($news->id); ?>"
...
<?php endif; ?><?php /**PATH C:\laragon\www\wagner\expressoVidaNova\resources\views/client/ajax/filter-blog-homePage.blade.php ENDPATH**/ ?>