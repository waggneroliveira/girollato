...
<head>
    ...
    <?php if(isset($blogInner)): ?>
        ...
        <meta property="og:description" content="<?php echo e(Str::limit(strip_tags($blogInner->text), 150)); ?>">
        ...
        <meta name="twitter:description" content="<?php echo e(Str::limit(strip_tags($blogInner->text), 150)); ?>">
                ...
                <div class="d-flex col-12 justify-content-between align-items-center wrap-logo-and-login">
                    <div class="logo-img px-0 py-2 rounded-2 d-flex justify-content-start align-items-center w-auto">
                        <a href="<?php echo e(route('index')); ?>">
                            <img src="<?php echo e(asset('build/client/images/expressovidadnova.png')); ?>" alt="Instituto Baiano de Medicina Desportivao" title="Instituto Baiano de Medicina Desportivao" class="img-fluid">
                        </a>
                    </div>
                ...
                <div class="container d-flex justify-content-between align-items-center h-100">
                    <div class="social-links d-flex justify-content-center align-items-center gap-4 text-center">
                        <nav class="none site-navigation ul position-relative text-end width-75 h-60">
                            <ul class="d-flex flex-row justify-content-start align-items-center gap-3 mb-0 list-unstyled h-100">
                                <li class="h-100 d-flex align-items-center px-2"><a href="<?php echo e(route('index')); ?>" class="nav-link montserrat-bold text-center font-12 text-uppercase">Principal</a></li>                                                   
                                        ...
                                        <?php if($blogCategories->count()): ?>
                                            <?php $__currentLoopData = $blogCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li>
                                                    ...
                                                    href="<?php echo e(route('blog', ['category' => $category->slug])); ?>#news">
                                ...
                                <li class="h-100 d-flex align-items-center px-2"><a href="<?php echo e(route('contact')); ?>" class="nav-link montserrat-bold text-center font-12 text-uppercase <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>">Contato</a></li>
                            </ul>                      
                        </nav>
                    ...
                    <div class="d-flex justify-content-center align-items-center gap-2 login-desktop col-6">   
                        <div class="d-flex justify-content-between gap-3 flex-wrap align-items-center col-8">
                           <form action="<?php echo e(route('blog-search')); ?>#news" class="search col-12" method="post">
                              <?php echo csrf_field(); ?>
                              <div class="input-group input-group-lg">
                                 <input type="search" name="search" class="rounded-0 form-control border-end-0 text-color montserrat-regular bg-white py-0" placeholder="Pesquise aqui">
                                 <button type="submit" title="search" class="btn-reset input-group-text bg-white border rounded-0">
...
</html><?php /**PATH C:\laragon\www\wagner\expressoVidaNova\resources\views/client/core/client.blade.php ENDPATH**/ ?>