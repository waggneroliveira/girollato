                                        ...
                                        <div class="position-relative overflow-hidden" style="height: 500px;">
                                            ...
                                            <div class="overlay">
                                                <div class="mb-3 d-flex justify-content-center align-items-center gap-1 flex-wrap">
                                                    <span class="badge rounded-0 background-red montserrat-semiBold font-12 text-uppercase py-2 px-2 me-2"><?php echo e($blogSuperHighlight->category->title); ?></span>                                   
                                                </div>
                                                <a href="<?php echo e(route('blog-inner', ['slug' => $blogSuperHighlight->slug])); ?>">
                                                    <h1 class="h2 m-0 text-white montserrat-bold font-32 d-block"><?php echo e($blogSuperHighlight->title); ?></h1>
                                                </a>
                                                <div class="description-blog mt-2"><?php echo substr(strip_tags($blogSuperHighlight->text), 0, 400); ?>...</div>

                                                <div class="d-flex justify-content-between gap-2 align-items-center w-100">
                                                    <p class="text-white mt-3 montserrat-regular font-15 col-8 col-lg-10"><?php echo e($dataFormatada); ?></p>

                                                    <div id="socialLinks-<?php echo e($blogSuperHighlight->id); ?>" class="social-links home opacity-0">
                                                        <div class="d-flex gap-2">
                                                            <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($blogSuperHighlight->title . ' ' . url()->current())); ?>" target="_blank" class="rounded-circle btn btn-sm bg-whatsapp bg-transparent p-0"><i class="fab fa-whatsapp text-white"></i></a>    
                                                            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($blogSuperHighlight->title)); ?>" target="_blank" class="rounded-circle btn btn-sm btn-twiter bg-transparent p-0"><i class="fab fa-x-twitter text-white"></i></a>
                                                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="rounded-circle btn btn-facebook btn-sm bg-transparent p-0"><i class="fab fa-facebook-f text-white"></i></a>
                                                        </div>
                                                    </div>  

                                                    <button id="shareBtn-<?php echo e($blogSuperHighlight->id); ?>" 
                                                            data-target="socialLinks-<?php echo e($blogSuperHighlight->id); ?>"
                                        ...
                                        <div class="position-relative overflow-hidden" style="height: 246px;">
                                            ...
                                            <div class="overlay">
                                                <div class="mb-2 d-flex justify-content-start align-items-center gap-1 flex-wrap">
                                                    <span class="badge rounded-0 background-red text-uppercase montserrat-semiBold font-12 py-2 px-2 me-2"><?php echo e($blogHighlight->category->title); ?></span>
                                                </div>
                                                <a href="<?php echo e(route('blog-inner', ['slug' => $blogHighlight->slug])); ?>">                              
                                                    <h2 class="h6 m-0 text-white montserrat-bold font-20 d-block"><?php echo e($blogHighlight->title); ?></h2>
                                                </a>
                                                <div class="d-flex justify-content-between align-items-center w-100">
                                                    <p class="text-white mt-3 montserrat-regular font-14 col-8"><?php echo e($dataFormatada); ?></p>
                                                    
                                                    <div id="socialLinks-<?php echo e($blogHighlight->id); ?>" class="social-links home opacity-0">
                                                        <div class="d-flex gap-2">
                                                            <a href="https://api.whatsapp.com/send?text=<?php echo e(urlencode($blogHighlight->title . ' ' . url()->current())); ?>" target="_blank" class="rounded-circle btn btn-sm bg-whatsapp bg-transparent p-0"><i class="fab fa-whatsapp text-white"></i></a>    
                                                            <a href="https://twitter.com/intent/tweet?url=<?php echo e(urlencode(url()->current())); ?>&text=<?php echo e(urlencode($blogHighlight->title)); ?>" target="_blank" class="rounded-circle btn btn-sm btn-twiter bg-transparent p-0"><i class="fab fa-x-twitter text-white"></i></a>
                                                            <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(urlencode(url()->current())); ?>" target="_blank" class="rounded-circle btn btn-facebook btn-sm bg-transparent p-0"><i class="fab fa-facebook-f text-white"></i></a>
                                                        </div>
                                                    </div>  

                                                    <button id="shareBtn-<?php echo e($blogHighlight->id); ?>" 
                                                            data-target="socialLinks-<?php echo e($blogHighlight->id); ?>"
                                                            class="share-button d-flex">
...
<?php echo $__env->make('client.core.client', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\wagner\expressoVidaNova\resources\views/client/blades/index.blade.php ENDPATH**/ ?>