                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Categorias de Produtos</h4>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                            ...
                            <div class="card-body">
                                <div class="row mb-2">
                                    <div class="col-12 d-flex justify-between">
                                        <div class="col-6">
                                            @if (Auth::user()->can('categorias de produtos.visualizar') &&
                                            Auth::user()->can('categorias de produtos.remover') ||
                                        ...
                                        <div class="col-6 d-flex justify-content-end">
                                            @if (Auth::user()->can('categorias de produtos.visualizar') &&
                                            Auth::user()->can('categorias de produtos.criar') ||
                                            Auth::user()->can('usuario.tornar usuario master') || 
                                            Auth::user()->hasRole('Super'))
                                                <button type="button" class="btn btn-primary text-black waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#productCategory-create"><i class="mdi mdi-plus-circle me-1"></i> {{__('dashboard.btn_create')}}</button>
                                                <!-- Modal -->
                                ...
                                <div class="table-responsive">
                                    <table class="table-sortable table table-centered table-nowrap table-striped">
                                        ...
                                        <tbody data-route="{{route('admin.dashboard.productCategory.sorting')}}">
                                            @foreach ($blogCategories as $key => $productCategory)
                                                <tr data-code="{{$productCategory->id}}">
                                                    ...
                                                    <td class="d-flex gap-lg-1 justify-center">
                                                        @if (Auth::user()->can('categorias de produtos.visualizar') &&
                                                        Auth::user()->can('categorias de produtos.editar') ||
                                                        Auth::user()->can('usuario.tornar usuario master') || 
                                                        Auth::user()->hasRole('Super'))
                                                            <button class="table-edit-button btn btn-primary text-black" data-bs-toggle="modal" data-bs-target="#modal-group-edit-{{$productCategory->id}}" style="padding: 2px 8px;width: 30px"><span class="mdi mdi-pencil"></span></button>
