...
<div class="mb-3">
    ...
    <input type="text" name="number" class="form-control" id="number{{isset($benefitTopic->id)?$benefitTopic->id:''}}" value="{{isset($benefitTopic)?$benefitTopic->number:''}}" placeholder="Título">
</div>
<div class="col-12">
    <div class="mt-3">
